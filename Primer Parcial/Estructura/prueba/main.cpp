...
int main(int argc, const char * argv[]) {
    ...
    Helper::print("Welcome to the path counter. The counter can only follow paths that jump " + jumpRight + " columns to the right and " + jumpDown + " rows down. We start at the 0, 0 position and end at the rows-1, columns-1 position.");
    
    Helper::print("The total number of possible paths is: " + possiblePaths(Helper::read<int>("What is the number of rows in the board?"), Helper::read<int>("What is the number of columns in the board?"), 0, 0));
